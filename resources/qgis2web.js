...
map.getView().fit([8464165.037608, 1201314.149064, 8488924.780532, 1218038.936579], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Pattambi webgis</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (40 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Pattambi is located in Palakkad District';
            }
